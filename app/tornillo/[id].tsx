...
export default function TornilloDetail() {
  ...
  if (!tornillo) return <View style={styles.center}><Text>No encontrado</Text></View>;
      ...
      <ScrollView contentContainerStyle={styles.container}>
          ...
          <View style={styles.appBarLeft}>
            ...
            <View>
              ...
              <Text style={styles.appBarSub}>
                {tornillo.nombreModulo} {tornillo.familia ? `| ${tornillo.familia}` : ''}
              </Text>
            </View>
          </View>
          <View style={{ width: 32 }} />
        ...
        <View style={styles.card}>
          ...
          <View style={styles.actionsRow}>
            <TouchableOpacity style={styles.secondaryBtn} onPress={goBackToNevera} disabled={saving}>
