...
export default function OrganizarIndex() {
  ...
  const goFamilia = (familia: string) => {
    router.push({ pathname: '/organizar/familia', params: { familia, tiendaId } });
  };
      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={[styles.container, { minHeight: height }]}>
        ...
        <View style={styles.appBar}>
          <View style={styles.appBarLeft}>
            ...
            <View>
              <Text style={styles.appBarTitle}>Organizar</Text>
