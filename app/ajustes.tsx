      ...
      >
        ...
        <View style={styles.card}>
          ...
          <TouchableOpacity
            style={styles.row}
            activeOpacity={0.85}
            onPress={() => go("/ajustes/anadir-tornillo")}
          >
            <Image
            ...
            <View style={styles.rowTextWrap}>
              ...
              <Text style={styles.rowSub}>
                Dar de alta un tornillo para controlar
              </Text>
            </View>
          ...
          <TouchableOpacity
            style={styles.row}
            activeOpacity={0.85}
            onPress={() => go("/ajustes/editar-tornillo")}
          >
            <Image
            ...
            <View style={styles.rowTextWrap}>
              ...
              <Text style={styles.rowSub}>
                Modificar caducidad, módulo o posición
              </Text>
            </View>
            <Text style={styles.chevron}>›</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            style={styles.row}
            activeOpacity={0.85}
            onPress={() => go("/ajustes/eliminar-tornillo")}
          >
            <Image
        ...
        <View style={styles.card}>
          ...
          <TouchableOpacity
            style={styles.row}
            activeOpacity={0.85}
            onPress={() => go("/organizar")}
          >
            <Image
              source={require("@/assets/images/organizar.png")}
              style={styles.icon}
            />
            <View style={styles.rowTextWrap}>
              <Text style={styles.rowText}>Organizar cámaras</Text>
              <Text style={styles.rowSub}>
                Editar módulos, filas o columnas
              </Text>
            </View>
            <Text style={styles.chevron}>›</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            style={styles.row}
            activeOpacity={0.85}
            onPress={() => go("/planogramas")}
          >
            <Image
              source={require("@/assets/images/planograma.png")}
              style={styles.icon}
            />
            <View style={styles.rowTextWrap}>
              <Text style={styles.rowText}>Planogramas</Text>
              <Text style={styles.rowSub}>
                Observar planogramas con información detallada
              </Text>
            </View>
            <Text style={styles.chevron}>›</Text>
          </TouchableOpacity>
