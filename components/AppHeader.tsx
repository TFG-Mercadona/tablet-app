    ...
    <SafeAreaView style={{ backgroundColor: '#0F8A2F' }}>
      <View style={{
        ...
        <View style={{ alignItems: 'center', flex: 1 }}>
          ...
          {!!subtitle && <Text style={{ color: 'rgba(255,255,255,0.85)', fontSize: 12 }}>{subtitle}</Text>}
        </View>
